...
#./vcsa-deploy install --no-esx-ssl-verify --accept-eula --acknowledge-ceip /data/cPod/shwrfr/alex-psc.json
#popd
...
./vcsa-deploy install --no-esx-ssl-verify --accept-eula --acknowledge-ceip /data/cPod/shwrfr/alex-vcsa.json
popd
